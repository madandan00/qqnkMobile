...
function getGoosListObj(){
	 ...
	 */
	var goodsListStr = $.fn.cookie("goodsList");
	if(!goodsListStr){  //如果没有
		$.fn.cookie("goodsList","[]");
		goodsListStr = $.fn.cookie("goodsList");
...
function  addGoodsToCart(goods){
	...
	$.fn.cookie("goodsList",goodListStr);
}
